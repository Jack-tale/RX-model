...
# Divide the dataset into training subset and validation subset (4:1).
train_subset, validation_subset, train_subset_labels, validation_subset_labels = train_test_split(dataset, labels, test_size = .2, stratify = labels)
...
torch.save(model_ft, "../Trained model/ResNet.pth")
